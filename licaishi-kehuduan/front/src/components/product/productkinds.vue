        ...
        <ul>
          <li class="tiaojian-content">
            ...
            <div class="tiaojian-info">
              <div class="tiaojian-info-one" v-for="(item,index) in items" :key="index">{{item}}</div>
            </div>
          </li>
          <li class="tiaojian-content">
            <div class="tiaojian-title">产品期限</div>
  ...
  methods: {
    ...
    searchProduct() {
      ...
      window.phihome.util.netRequest(
        "get",
        _this.neturl + "srv/v1/product/list?pageNo=1&pageSize=10&type=03",
        "",
        "",
        function(response) {
